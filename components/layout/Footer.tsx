      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="text-2xl font-bold inline-block mb-4 font-hind-siliguri text-luxe-gradient focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-royal focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-abyss rounded-sm"
            >
              ধোঁয়া-মুক্ত পথ
            </Link>
            ...
            <ul className="space-y-3">
              {productLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="group text-white-pure/75 hover:text-gold-glow transition-colors font-noto-bengali inline-flex items-center gap-1.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-royal focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-abyss rounded-sm"
                  >
                    <span
                      aria-hidden="true"
            ...
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="group flex items-center gap-2 text-white-pure/75 hover:text-gold-glow transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-royal focus-visible:ring-offset-2 focus-visible:ring-offset-emerald-abyss rounded-sm"
